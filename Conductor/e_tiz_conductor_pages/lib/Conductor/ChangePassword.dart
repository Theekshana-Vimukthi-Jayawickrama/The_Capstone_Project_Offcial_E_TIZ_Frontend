...
import 'package:e_tiz_conductor_pages/Conductor/PasswordChangeSucessful.dart';
...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  Future<void> forgotPassword() async {
    ...
    final response = await http.put(
        Uri.parse(
            'http://192.168.43.220:8080/api/v1/auth/updatePassword/conductor/${widget.userName}'),
